...
static_assert(offsetof(HudArm32Layout, menuOriginX) == 0x4cc, "");
static_assert(offsetof(HudArm32Layout, menuOriginYBase) == 0x4d0, "");
static_assert(offsetof(HudArm32Layout, boostReadyTextX) == 0x4d4, "");
static_assert(offsetof(HudArm32Layout, touchHalfExtent) == 0x4d8, "");
static_assert(offsetof(HudArm32Layout, touchHalfExtentSmall) == 0x4dc, "");
static_assert(offsetof(HudArm32Layout, analogStickRadius) == 0x4e0, "");
static_assert(offsetof(HudArm32Layout, radarBottomInset) == 0x4e4, "");
