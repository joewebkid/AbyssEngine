...
struct HudArm32Layout {
    ...
    std::uint8_t unknown_48c[0x0c];
    std::int32_t cloakFlashRemaining;
    std::int32_t cloakFlashPulse;
    std::uint8_t autofireEnabled;
    std::uint8_t unknown_4a1[4];
    std::uint8_t fireForTutorial;
    std::uint8_t unknown_4a6[0x16];
...
static_assert(offsetof(HudArm32Layout, cloakFlashRemaining) == 0x498, "");
