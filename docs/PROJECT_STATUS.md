...
| `MGame` touch routing | The `Hud::touchEnd` branch now covers pause, primary-fire/hacking/auto-turret combat actions, quick-menu/orbit actions, and the paused autopilot-menu, StarMap, ordinary ChoiceWindow, and MenuTouchWindow routes. See `MGAME_HUD_ACTION_ROUTING_2026-07-20.md` and `MGAME_PAUSED_TOUCH_ROUTING_2026-07-20.md`. | Boost, game-over, dialogue/cutscene, and selector-specific ChoiceWindow branches remain separate work; no ARM byte-match claim. |
