...
`HUD_INIT_MENU_RESOURCE_CHAIN_ARM_2026-08-22.md`, and supersede the older inline
Hud figures above. The 48-function Hud set now averages `89.0%`, with 26
...
`84.3%` at `225/221` target/base instructions.
