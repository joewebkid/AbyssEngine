...
| `MGame` touch routing | The `Hud::touchEnd` branch now covers the native pause-menu action, quick-menu/orbit actions, and the paused autopilot-menu, StarMap, ordinary ChoiceWindow, and MenuTouchWindow routes. See `MGAME_HUD_ACTION_ROUTING_2026-07-20.md` and `MGAME_PAUSED_TOUCH_ROUTING_2026-07-20.md`. | Dialogue/cutscene, game-over, and selector-specific ChoiceWindow branches remain separate work; no ARM byte-match claim. |
