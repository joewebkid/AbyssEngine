...
inline Hud figures above. The 48-function Hud set now averages `89.1%`, with 26
...
49.3%, `drawOrbitInformation` 56.3%, and `initHudMenu` 39.1% at `1245/1236`
...
restores per-row `Layout+0x30` loads while retaining only `Layout+0x1dc`, taking
the generated menu body to within nine instructions of the Android count.
